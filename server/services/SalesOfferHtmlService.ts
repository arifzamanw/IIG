...
export function generateSalesOfferHtml(proposal: any): string {
  ...
  const headerHtml = `
    <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:36px;">
      ...
      <div style="display:flex;align-items:center;gap:10px;">
        <div style="width:44px;height:44px;border:2.5px solid #c0392b;display:flex;align-items:center;justify-content:center;font-size:18px;font-weight:900;color:#c0392b;letter-spacing:-1px;">IG</div>
        <div>
          <div style="font-size:12px;font-weight:800;letter-spacing:0.06em;color:#1a1a1a;line-height:1;">INVEST</div>
          <div style="font-size:12px;font-weight:800;letter-spacing:0.06em;color:#1a1a1a;line-height:1;">GEORGIA</div>
          <div style="font-size:10px;color:#888;letter-spacing:0.1em;margin-top:2px;">UAE</div>
        </div>
      </div>
    </div>`
